...
echo "Running erc20..."
yes | contender spam -r $RPC_URL -p $KEY_4 --tps 30 -d $1 --min-balance 0.1eth -a 800 --op erc20
yes | contender spam -r $RPC_URL -p $KEY_5 --tps 90 -d $1 --min-balance 0.1eth -a 800 --op erc20
yes | contender spam -r $RPC_URL -p $KEY_6 --tps 270 -d $1 --min-balance 0.1eth -a 800 --op erc20
