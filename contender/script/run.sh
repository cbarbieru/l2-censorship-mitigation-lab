...
# export RPC_URL=http://op-geth.test-1.svc.cluster.local:8545
export RPC_URL=http://op-rbuilder.test-2.svc.cluster.local:8545
# export RPC_URL=http://tx-order-guarantor.test-3.svc.cluster.local:1545
