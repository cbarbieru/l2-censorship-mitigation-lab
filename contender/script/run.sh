...
yes | contender spam -r $RPC_URL -p $KEY_1 --tps 30 -d $1 -a 15 --op erc20

echo "Running erc20 with 90 TPS..."
yes | contender spam -r $RPC_URL -p $KEY_2 --tps 90 -d $1 -a 45 --op erc20

echo "Running erc20 with 270 TPS..."
yes | contender spam -r $RPC_URL -p $KEY_3 --tps 270 -d $1 -a 135 --op erc20
